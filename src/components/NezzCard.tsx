...
import { NEZZ_PROFILE } from '../data/profiles';

interface NezzCardProps {
  profile?: ProfileData;
...
export const NezzCard: React.FC<NezzCardProps> = ({
  profile = NEZZ_PROFILE,
  ...
  return (
    <div className="relative w-full h-full rounded-[24px] overflow-hidden flex flex-col justify-between text-slate-200 select-none transition-all duration-500 border border-purple-500/40 bg-[#090412] shadow-[0_0_60px_rgba(168,85,247,0.25)]">
      ...
      <div className="px-5 py-3 border-t border-purple-500/30 bg-purple-950/50 backdrop-blur-md flex items-center justify-between relative z-10 shrink-0">
        <button
